...
<p align="center">
  <img src="screenshots/01_dashboard.png" width="22%" alt="Dashboard" />
  <img src="screenshots/06_add_expense.png" width="22%" alt="Add Expense" />
  <img src="screenshots/02_forecast.png" width="22%" alt="Spending Forecast" />
  <img src="screenshots/05_silent_drains.png" width="22%" alt="Silent Drains" />
</p>
<p align="center">
  <img src="screenshots/08_budget.png" width="22%" alt="Budget Settings" />
  <img src="screenshots/07_sms_monitoring.png" width="22%" alt="SMS Monitoring" />
  <img src="screenshots/03_splits.png" width="22%" alt="Bill Splits" />
  <img src="screenshots/04_profile.png" width="22%" alt="Profile" />
</p>
...
- Auto-logs detected expenses to Firestore with category mapping
...
- Converts weekly and fortnightly charges to monthly equivalents
...
The project includes **138 unit and widget tests** covering all core logic. Run them with:
...
|---|---|---|
| `test/bank_sms_parser_test.dart` | 39 | SMS parsing: skip rules, amount extraction, merchant, date, card, category, 9 real-world SMS samples |
| `test/models/expense_test.dart` | 24 | `SplitPerson` serialization, `Expense.totalOwed`, `toFirestore`, `kExpenseCategories`, `kDefaultEssentialMap` |
| `test/models/budget_test.dart` | 13 | `Budget` fromFirestore/toFirestore round-trip, `hasCategoryBudgets`, `copyWith` |
| `test/models/bank_sender_test.dart` | 12 | `BankSender` toMap/fromMap, `kCommonBdBankSenders` completeness |
| `test/services/forecast_service_test.dart` | 16 | Forecast structure, expense filtering, weekly/fortnightly/monthly conversion, sorting, totals |
| `test/services/drain_service_test.dart` | 13 | `toMonthlyAmount` all intervals, `totalMonthlyCost` aggregation |
| `test/core/utils_test.dart` | 12 | `friendlyAuthError` all Firebase error codes |
| `test/widget_test.dart` | 9 | Category list rendering, split-person states, budget period labels, `totalOwed` display |
